...
public class CreateIssueCommandFromResourceAssembler {
    public static CreateIssueCommand toCommandFromResource(CreateIssueResource resource) {
        return new CreateIssueCommand(resource.title(),resource.sprintAssociate() , resource.description(), resource.status(), resource.priority(), resource.assignedTo(), resource.madeBy(), resource.createdIn(), resource.resolutionDate());
    }
}
